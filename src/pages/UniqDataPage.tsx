  ...
  return (
    <PageLayout>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">UniQdata의 혁신적 기능</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">블록체인 데이터 보호</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">데이터 판매 수익</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">의료비 30% 회수</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">데이터 수집</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">익명화 처리</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">데이터 판매</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold mb-2">수익 분배</h4>
              <p className="text-sm text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">데이터가 돈이 되는 시대</h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">투명한 수익 구조</h4>
                    <p className="text-gray-600">블록체인으로 모든 거래가 투명하게 기록됩니다</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-600 mr-3 text-xl">✓</span>
                  <div>
                    <h4 className="font-semibold mb-1">안전한 데이터 이전</h4>
                    <p className="text-gray-600">SportiQue 서비스 간 데이터를 안전하게 이전합니다</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="text-purple-600 mr-3 text-xl">✓</span>
                  <div>
                    <h4 className="font-semibold mb-1">지속적인 수익 창출</h4>
                    <p className="text-gray-600">데이터가 판매될 때마다 수익을 받습니다</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">철저한 보안</h2>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">🔐</div>
              <h3 className="text-lg font-bold mb-2">완전한 익명화</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <h3 className="text-lg font-bold mb-2">블록체인 암호화</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">🛡️</div>
              <h3 className="text-lg font-bold mb-2">데이터 소유권</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl font-bold mb-6">데이터 지키고, 수익도 창출</h2>
