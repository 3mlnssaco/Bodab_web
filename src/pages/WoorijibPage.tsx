    ...
    <PageLayout>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2">가족 전용 메신저</h3>
              <p className="text-sm sm:text-base text-gray-600">광고 없는 깨끗한 가족 소통 공간</p>
            </div>

            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">📸</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">자동 앨범 정리</h3>
              <p className="text-sm sm:text-base text-gray-600">AI가 자동으로 사진과 동영상을 정리</p>
            </div>

            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">📅</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">가족 일정 공유</h3>
              <p className="text-sm sm:text-base text-gray-600">중요한 가족 일정을 함께 관리</p>
            </div>

            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">👴</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">부모님 모드</h3>
              <p className="text-sm sm:text-base text-gray-600">큰 글씨와 간편한 인터페이스</p>
            </div>

            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🏥</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">건강 체크</h3>
              <p className="text-sm sm:text-base text-gray-600">가족 구성원의 건강 상태 확인</p>
            </div>

            <div className="bg-white p-5 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="text-2xl sm:text-3xl mb-3 sm:mb-4">🔒</div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2">프라이버시 보장</h3>
              <p className="text-sm sm:text-base text-gray-600">가족 데이터의 안전한 보호</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 px-2">접근성 향상 연구 프로젝트</h2>
